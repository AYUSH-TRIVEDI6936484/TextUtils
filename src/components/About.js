...
export default function About() {
    ...
    const [btntxt, newbtn] = useState("Enable Dark Mode");
    const clickedmode = () => {
    ...
    return (
        <div className="container" style={myStyle}>
                ...
                <div className="accordion-item">
                    ...
                    <div id="collapseThree" className="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                        <div className="accordion-body" style={myStyle}>
                            ...
                            appropriate classNamees that we use to style each element. These classNamees control the overall appearance, as well as the showing
            ...
            <div className="container my-3">
                <button onClick={clickedmode} type='button' className='btn btn-primary'>{btntxt}</button>
            </div>
        </div>
    )
}
